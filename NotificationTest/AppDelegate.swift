...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func configureNotifications(){
        let dismissAction = UNNotificationAction(identifier: "dismissAlarm", title: "Dismiss", options: [])
        let snoozeAction = UNNotificationAction(identifier: "snoozeAlarm", title: "Snooze", options: [])
        let category = UNNotificationCategory(identifier: "alarmCategory", actions: [dismissAction,snoozeAction], intentIdentifiers: [], options: [.customDismissAction])
